...
<head>
    ...
    <title>Settings - Kazakh Language Teaching Platform</title>
...
<div class="profile-container">
    ...
    <div class="profile-dropdown">
        ...
        <div class="dropdown-item" onclick="logout()">Exit</div>
    </div>
</div>
...
<div class="container">
    ...
    <div class="text-center mt-4">
        <button class="btn btn-custom" onclick="saveSettings()">Save settings</button>
    </div>
</div>
