...
<head>
    ...
    <title>Аудиокітаптар тізімі</title>
    <style>
        body {
    ...
    <div class="container">
        ...
        <table>
            ...
            <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <audio controls class="playback-control">
                                    ...
                                    Сіздің браузеріңіз бұл аудионы қолдамайды.
                                </audio>
                                <a href="<?= htmlspecialchars($audiobook['audio_path']); ?>" download>Жүктеу</a>
                                <!-- Контроль скорости воспроизведения -->
                                <label for="playback-speed-<?= $audiobook['id']; ?>">Скорость:</label>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="4" style="text-align:center;">Аудиокітаптар табылмады.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
